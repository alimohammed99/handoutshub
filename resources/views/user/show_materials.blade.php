            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <img class="img-fluid rounded-circle" src="/logoimage/{{$dataa->image}}"alt="logo" width="120" height="120"> 
...
@if (Route::has('login'))
 ...
 @endif
    ...
    <section style="margin-top:5%" class="section" id="">
        <div class="container">
            <div class="row">
             
                <div class="col-lg-12 col-md- col-xs-">
...
<h1 style="color:red; font-size:20px">NOTE: Materials for previous levels are also made availabe incase of Carry overs or References. <br> <br> Your CURRENT level materials come first at the top.</h1> <br>
...
<table style="" id="hundred_level_students" class="table table-lg table-bordered table-hover">
  <thead class="thead-dark">
    <tr style="text-align:center">
      ...
      <th colspan="2" style="text-align:center" scope="">ACTION</th>
    </tr>
  </thead>
  <tbody>

  @foreach($data as $data)
  <tr class="" style="color:; font-size: ">
      <td>{{$data->title}}</td>
      <td>{{$data->description}}</td>
      <td>{{$data->file}}</td>
      <td style="text-align:center"> <a class="btn btn-primary" style="font-size:" href="{{url('user_view_material', $data->id)}}">View</a> </td>
